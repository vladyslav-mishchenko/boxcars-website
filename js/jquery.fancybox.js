    ...
    $.extend(FancyBox.prototype, {
        ...
        afterLoad: function (slide) {
            ...
            if (slide.opts.smallBtn && !slide.$smallBtn) {
                slide.$smallBtn = $(self.translate(slide, slide.opts.btnTpl.smallBtn)).appendTo(
                    slide.$content.filter('div,form').first()
                );
            }
        ...
        close: function (e, d) {
            ...
            if (effect === 'zoom') {
                ...
                if (opacity == 'auto') {
                    opacity =
                        Math.abs(current.width / current.height - end.width / end.height) > 0.1;
                }
        ...
        if (type) {
            ...
            if (type === 'iframe') {
                ...
                item.opts.slideClass +=
                    ' fancybox-slide--' +
                    (provider == 'gmap_place' || provider == 'gmap_search' ? 'map' : 'video');
            }
        } else if (url) {
...
(function (window, document, $) {
    ...
    var isClickable = function ($el) {
        if (
            $el.is('a,area,button,[role="button"],input,label,select,summary,textarea') ||
    ...
    Guestures.prototype.ontouchstart = function (e) {
        ...
        if (
            ...
            self.centerPointStartX =
                (self.startPoints[0].x + self.startPoints[1].x) * 0.5 - $(window).scrollLeft();
            self.centerPointStartY =
                (self.startPoints[0].y + self.startPoints[1].y) * 0.5 - $(window).scrollTop();
    ...
    Guestures.prototype.limitPosition = function (newOffsetX, newOffsetY, newWidth, newHeight) {
        ...
        if (newHeight > canvasHeight) {
            ...
            newOffsetY =
                newOffsetY < canvasHeight - newHeight ? canvasHeight - newHeight : newOffsetY;
        } else {
            // Center vertically
...
(function (document, $) {
    ...
    $.extend(FancyThumbs.prototype, {
        ...
        create: function () {
            ...
            self.$grid = $(
                '<div class="fancybox-thumbs fancybox-thumbs-' + self.opts.axis + '"></div>'
                ...
                if (gallery && gallery !== '') {
                    ...
                    if ('replaceState' in window.history) {
                        ...
                        timerID = setTimeout(function () {
                            window.history[shouldCreateHistory ? 'pushState' : 'replaceState'](
                                {},
                                document.title,
