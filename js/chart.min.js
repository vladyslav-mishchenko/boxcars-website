                                ...
                                render: function (e) {
                                    ...
                                    if (!1 !== l.notify(i, 'beforeRender')) {
                                        ...
                                        if (
                                            ...
                                            (i.draw(),
                                                s(new t.Animation({ numSteps: 0, chart: i })));
                                        return i;
                                    }
                                },
                                draw: function (t) {
                        ...
                        modes: {
                            ...
                            dataset: function (t, e, i) {
                                ...
                                var o = l(i.axis),
                                    u = i.intersect ? r(t, n) : s(t, n, !1, o);
                                return (
                                    u.length > 0 && (u = t.getDatasetMeta(u[0]._datasetIndex).data),
                                    u
                                );
                            },
                            'x-axis': function (t, e) {
                                ...
                                return (
                                    r.length > 1 &&
                                        r.sort(function (t, e) {
                                            ...
                                            return (
                                                0 === i && (i = t._datasetIndex - e._datasetIndex),
                                                i
                                            );
                                        }),
                                    r.slice(0, 1)
                            ...
                            t.Scale = a.extend({
                                ...
                                draw: function (t) {
                                    ...
                                    if (a.display) {
                                        ...
                                        if (h.drawBorder) {
                                            ((s.lineWidth = o.valueAtIndexOrDefault(
                                                h.lineWidth,
                                                0
                                            )),
                                                (s.strokeStyle = o.valueAtIndexOrDefault(
                                                    h.color,
                                                    0
                                                )));
                                            var B = e.left,
                                            ...
                                            (p
                                                ? ((N = V =
                                                      'top' === a.position ? e.bottom : e.top),
                                                  (N += E),
                                                  (V += E))
                                                : ((B = W =
                                                      'left' === a.position ? e.right : e.left),
                                                  (B += E),
                                                  (W += E)),
                                                s.beginPath(),
                                                s.moveTo(B, N),
                                ...
                                update: function (e) {
                                    ...
                                    if (I.length) {
                                        ...
                                        (C.filter &&
                                            ...
                                            o.each(z, function (t) {
                                                (R.push(
                                                    C.callbacks.labelColor.call(S, t, S._chart)
                                                ),
                                                    L.push(
                                            ...
                                            'top' === m
                                                ? (c += v)
                                                : (c -=
                                                      'bottom' === m ? s.height + v : s.height / 2),
                                            'center' === m
                                                ? 'left' === p
                                                    ? (d += v)
                                                    : 'right' === p && (d -= v)
                                    ...
                                    (y._unit =
                                        ...
                                        (function (t, e, i, a) {
                                            ...
                                            for (o = u.length - 1; o >= u.indexOf(e); o--)
                                                if (
                                                    ((r = u[o]), l[r].common && s.as(r) >= t.length)
                                                )
                                                    return r;
