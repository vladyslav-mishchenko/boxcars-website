    ...
    function (e, t, n) {
        ...
        function a(e, t) {
            for (var n in ('object' != o(e) && (e = {}), 'object' != o(t) && (t = {}), t))
                t.hasOwnProperty(n) &&
                    (void 0 === e[n] ? (e[n] = t[n]) : 'object' == o(e[n]) && a(e[n], t[n]));
            return e;
        }
        function o(e) {
            return {}.toString
        ...
        var S = (function () {
                ...
                return (
                    ...
                    (e.prototype.togglePanel = function (e) {
                        var t = e.parentElement;
                        t.matches('.mm-listitem_vertical') &&
                            this[t.matches('.mm-listitem_opened') ? 'closePanel' : 'openPanel'](e);
                    }),
                    ...
                    (e.prototype._initPanel = function (e) {
                        ...
                        if (
                            (e.classList.remove(this.conf.classNames.vertical), e.matches('ul, ol'))
                        ) {
                ...
                return (
                    (e.prototype.start = function (e) {
                        ...
                        if (!('number' == typeof i && this.currentPosition.y < i)) {
                            ...
                            if (
                                !('number' == typeof s && ((s = t - s), this.currentPosition.x > s))
                            ) {
            ...
            (_e.navbarContents = {
                    ...
                    (e.append(n),
                        this.bind('initNavbar:after', function (e) {
                            if (!e.querySelector('.mm-navbar__breadcrumbs')) {
                                ...
                                for (
                                    var n = [], i = b('span.mm-navbar__breadcrumbs'), s = e, a = !0;
                                    s;
                ...
                prev: function (e) {
                    ...
                    (e.append(a),
                        ...
                        this.bind('openPanel:start', function (e) {
                            e.parentElement.matches('.mm-listitem_vertical') ||
                                ((t = e.querySelector('.' + s.conf.classNames.navbars.panelPrev)) ||
                    ...
                    (o.append(r),
                        ...
                        this.bind('openPanel:start', function (e) {
                            e.parentElement.matches('.mm-listitem_vertical') ||
                                ...
                                (t = i && i.closest('a') ? i.closest('a').getAttribute('href') : '')
        ...
        var Se = function () {
            ...
            Me = function (e) {
                ...
                i(r, n.input),
                n.clear) &&
                    ((s = b('a.mm-btn.mm-btn_close.mm-searchfield__btn')).setAttribute('href', '#'),
                    o.append(s));
                (i(a, n.form), n.form && n.submit && !n.clear) &&
                    ((s = b('a.mm-btn.mm-btn_next.mm-searchfield__btn')).setAttribute('href', '#'),
                    o.append(s));
                t.cancel &&
        ...
        ((S.addons = {
            ...
            columns: function () {
                ...
                if (((this.opts.columns = a(t, S.options.columns)), t.add)) {
                    ...
                    for (
                        var n = [],
                            i = [],
                            s = ['mm-panel_opened', 'mm-panel_opened-parent', 'mm-panel_highest'],
                            o = 0;
                        o <= t.visible.max;
                        o++
                    )
            ...
            counters: function () {
                var e = this,
                    t = (function (e) {
                        return (
                            'boolean' == typeof e && (e = { add: e, addTo: 'panels', count: e }),
                            'object' != typeof e && (e = {}),
                ...
                if (
                    ...
                    var n = function (t) {
                        (t ? [t.closest('.mm-panel')] : _(e.node.pnls, '.mm-panel')).forEach(
                            function (e) {
                                var t = e.mmParent;
                                if (t) {
                ...
                if (this.opts.offCanvas) {
                    var t = (function (e) {
                        return (
                            ...
                            'object' != typeof e && (e = {}),
                            'string' == typeof e.position && (e.position = { of: e.position }),
                            e
                        );
                    })(this.opts.dropdown);
                            ...
                            return (
                                ...
                                'after' == v
                                    ? ((r = _ - ((o = 'x' == e ? b : g) + y)),
                                      ...
                                      (c[p] = 'auto'),
                                      t.tip && l.push('mm-menu_tip-' + ('x' == e ? 'left' : 'top')))
                                    : ((r = (o = 'x' == e ? g : b) - y),
            ...
            keyboardNavigation: function () {
                ...
                if (!U) {
                    var t = (function (e) {
                        return (
                            ('boolean' != typeof e && 'string' != typeof e) || (e = { enable: e }),
                            'object' != typeof e && (e = {}),
                            e
                        );
                    })(this.opts.keyboardNavigation);
                    if (
                        ((this.opts.keyboardNavigation = a(t, S.options.keyboardNavigation)),
                        t.enable)
                    ) {
                            ...
                            this.bind('initOpened:before', function () {
                                (e.node.menu.prepend(n),
                                    ...
                                    _(e.node.menu, '.mm-navbars-top, .mm-navbars-bottom').forEach(
                                        function (e) {
                                            e.querySelectorAll('.mm-navbar__title').forEach(
                                                function (e) {
            ...
            setSelected: function () {
                ...
                if (
                    ((this.opts.setSelected = a(t, S.options.setSelected)), 'detect' == t.current)
                ) {
                    var n = function (t) {
                        t = t.split('?')[0].split('#')[0];
                    ...
                    var t = (function (e) {
                        return (
                            ...
                            'boolean' == typeof e.collapsed &&
                                e.collapsed &&
                                (e.collapsed = { use: !0 }),
                            ('string' != typeof e.collapsed && 'number' != typeof e.collapsed) ||
