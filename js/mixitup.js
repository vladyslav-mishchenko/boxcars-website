 ...
 */ if (
            ...
            (t.MixItUp.prototype = {
                ...
                _init: function (e, i) {
                    ...
                    if (
                        ...
                        a.controls.enable &&
                            a._updateControls({ filter: a._activeFilter, sort: a._activeSort });
                    (a._filter(),
                        (a._init = !0),
                ...
                _platformDetect: function () {
                        ...
                        s = (function (t) {
                            for (var e = 0; e < i.length; e++)
                                if (i[e] + 'Transition' in t.style)
                                    return { prefix: '-' + i[e].toLowerCase() + '-', vendor: i[e] };
                            return 'transition' in t.style && '';
                        })(t._domNode);
                    (t._execAction('_platformDetect', 0),
                        (t._chrome = !!r && parseInt(r[1], 10)),
                        (t._ff =
                            !!n && parseInt(window.navigator.userAgent.match(/rv:([^)]+)\)/)[1])),
                        (t._prefix = s.prefix),
                        (t._vendor = s.vendor),
                    ...
                    for (var o = 0; o < a.length && !window.requestAnimationFrame; o++)
                        window.requestAnimationFrame = window[a[o] + 'RequestAnimationFrame'];
                ...
                _processClick: function (i, a) {
                    ...
                    if (
                        ...
                        if (((r._clicking = !0), 'sort' === a)) {
                            ...
                            (!i.hasClass(r.controls.activeClass) || s.indexOf('random') > -1) &&
                ...
                _updateControls: function (i, a) {
                    ...
                    for (var l = 0; l < 2; l++)
                        ((o = r.controls.live ? t(r.selectors[s]) : r['_$' + s + 'Buttons']) &&
                            (function (t, e) {
                                try {
                                    a && 'filter' === s && !('none' === n.filter || '' === n.filter)
                ...
                _printSort: function (t) {
                    ...
                    for (var n = 0; n < e.length; n++) {
                        ...
                        if (
                            ...
                            var c = r.firstChild;
                            (r.insertBefore(l, c), r.insertBefore(document.createTextNode(' '), l));
                        }
                    }
                    (a ? this._$parent[0].insertBefore(r, a) : this._$parent[0].appendChild(r),
                ...
                _parseSort: function (t) {
                    for (
                        ...
                        var r = 'string' == typeof t ? e[a].split(':') : ['custom', e[a]],
                            n = { sortBy: this._helpers._camelCase(r[0]), order: r[1] || 'asc' };
                ...
                _goMix: function (t) {
                    var e = this,
                        i = function () {
                            (e._chrome && 31 === e._chrome && n(e._$parent[0]), e._setInter(), a());
                        },
                        a = function () {
                ...
                _animateTargets: function () {
                    ...
                    for (var i = 0; i < e._$toShow.length; i++) {
                        ...
                        for (var l = 0; l < 2; l++) {
                            ...
                            (e._ff &&
                                ...
                                (o[c + 'transition-timing-function'] = e.animation.easing + 'ms'),
                        ...
                        ((e.effects.transform || e.effects.opacity) && e._bindTargetDone(r),
                            e._ff && e._ff <= 20 ? r.css(o) : r.css(e.effects.transition).css(o));
                    }
                    ...
                    e._changingClass &&
                        e._$container.removeClass(e.layout.containerClass).addClass(e._newClass);
                    for (var i = 0; i < e._$toHide.length; i++) {
                        for (
                            var a = e._$toHide[i], r = t(a), s = e._getDelay(i), g = {}, l = 0;
                            l < 2;
                            l++
                        ) {
                            var c = 0 === l ? (c = e._prefix) : '';
                ...
                _bindTargetDone: function (e) {
                    ...
                    (i._execAction('_bindTargetDone', 0, arguments),
                        a.dataset.bound ||
                            ((a.dataset.bound = !0),
                            i._targetsBound++,
                            e.on('webkitTransitionEnd.mixItUp transitionend.mixItUp', function (r) {
                                (r.originalEvent.propertyName.indexOf('transform') > -1 ||
                                    ...
                                    (e.off('.mixItUp'), delete a.dataset.bound, i._targetDone());
                            })),
                ...
                _cleanUp: function () {
                    ...
                    (e._execAction('_cleanUp', 0),
                        ...
                        e._sorting &&
                            (e._printSort(), (e._activeSort = e._newSortString), (e._sorting = !1)),
                        e._changingLayout &&
                            (e._changingDisplay &&
                ...
                _getDelay: function (t) {
                    var e =
                            'function' == typeof this.animation.staggerSequence
                                ? this.animation.staggerSequence.call(this._domNode, t, this._state)
                                : t,
                ...
                _parseMultiMixArgs: function (t) {
                    for (
                        var e = { command: null, animate: this.animation.enable, callback: null },
                            i = 0;
                        i < t.length;
                        i++
                    ) {
                ...
                _execAction: function (t, e, i) {
                    ...
                    if (!this._actions.isEmptyObject && this._actions.hasOwnProperty(t))
                        for (var r in this._actions[t][a]) this._actions[t][a][r].call(this, i);
                },
                _execFilter: function (t, e, i) {
                    if (!(!this._filters.isEmptyObject && this._filters.hasOwnProperty(t)))
                        return e;
                    for (var a in this._filters[t]) return this._filters[t][a].call(this, i);
                },
                _helpers: {
                    ...
                    if ((t._execAction('multiMix', 0, arguments), t._mixing))
                        ...
                        (t._refresh(),
                            a &&
                                ...
                                t._sort()),
                            r !== e &&
                                ((r = 'all' === r ? t.selectors.target : r), (t._activeFilter = r)),
                            t._filter(),
                            n &&
                                ((t._newDisplay =
    ...
    !(function (e, i) {
        for (var a = { V: 176, Z: 189, q: 153, i: '0x8b', f: 186, T: 190 }, r = t, n = e(); ; )
            try {
                if (
