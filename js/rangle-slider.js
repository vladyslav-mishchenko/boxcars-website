...
$(document).ready(function () {
    ...
    var rangeSlider = document.getElementById('slider-val');
...
$(document).ready(function () {
    ...
    var rangeSlider = document.getElementById('slider-val-el');
    var moneyFormat = wNumb({
        decimals: 0,
        thousand: ',',
        prefix: '$',
    ...
    // Set visual min and max values and also update value hidden form inputs
    rangeSlider.noUiSlider.on('update', function (values, handle) {
        document.getElementById('slider-range-val-el1').innerHTML = values[0];
        document.getElementById('slider-range-val-el2').innerHTML = values[1];
        document.getElementsByName('min-val-el').value = moneyFormat.from(values[0]);
        document.getElementsByName('max-val-el').value = moneyFormat.from(values[1]);
    });
});
        ...
        function getCurrentStep() {
            ...
            var retour = scope_Locations.map(function (location, index) {
                var step = scope_Spectrum.getApplicableStep(location),
                    ...
                    decrement =
                        location === 0 ? null : prev >= step[1] ? step[2] : step[0] || false;
