...
(function ($) {
    ...
    function mainMap() {
        var ib = new InfoBox();
        function locationData(locationImg, locationURL, locationTitle, job_type, job_address) {
            return (
                '' +
        ...
        var locations = [
            [
                ...
                -74.16938781738281,
                1,
                '<div style="background-image: url(images/resource/map-card.jpg);"></div>',
            ],
            [
                locationData(
                    'images/resource/map-card.jpg',
    ...
    CustomMarker.prototype.draw = function () {
        ...
        if (!div) {
            ...
            div.innerHTML =
                ...
                '<div class="marker-arrow">$28000</div>' +
                '</div>' +
                '</div>';
